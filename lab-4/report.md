...
subtitle: "Модель гармонических колебаний - вариант 48"
...
annotation(experiment(StartTime = 0, StopTime = 61, Interval = 0.05));

end lab4_1;
```

![График для первого случая](image/01.png){ #fig:001 width=70% height=70% }
...
![График для второго случая](image/03.png){ #fig:003 width=70% height=70% }
...
* Построены графики решения уравнения гармонического осциллятора и фазовые портреты гармонических колебаний без затухания, с затуханием и при действии внешней силы.
