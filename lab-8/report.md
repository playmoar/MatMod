...
subtitle: "Модель конкуренции двух фирм - вариант 48"
...
parameter Real p_cr = 31;
parameter Real N = 72;
parameter Real q = 1;
parameter Real tau1 = 30;
parameter Real tau2 = 34;
parameter Real p1 = 7.4;
parameter Real p2 = 5.4;
...
annotation(experiment(StartTime = 0, StopTime = 25, Interval = 0.05));
end lab8;
...
equation
der(M1) = M1 - (b / c1) * M1 * M2 - (a1 / c1) * M1 * M1;
der(M2) = (c2 / c1) * M2 - (b / c1 + d) * M1 * M2 - (a2 / c1) * M2 * M2;
